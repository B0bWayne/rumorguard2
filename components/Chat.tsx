...
const Chat = () => {
 ...
 messages: [
 { role: "system", content: "You are RumorGuard Uganda. You are an expert health fact-checker. Verify health rumors concisely and accurately." },
 ...
 setMessages(prev => [...prev, { role: 'assistant', content: 'Connection error. Please check your API key in Netlify!' }]);
 } finally {
 setIsLoading(false);
 }
 };
